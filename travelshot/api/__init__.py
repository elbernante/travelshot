...
def unauthorized_request(error):
    '''Error response for unauthorized request (e.g. requires authentication).'''
...
def not_found(error):
    ...
    return _error_message(error, 'The end point you requested was not found.'), \
        error.code
...
def not_allowed(error):
    ...
    return _error_message(error, 'The reuqest method is not allowed for this end point.'), \
        error.code
